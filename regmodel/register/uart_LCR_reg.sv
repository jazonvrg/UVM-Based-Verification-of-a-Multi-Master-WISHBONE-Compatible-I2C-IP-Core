class uart_LCR_reg extends uvm_reg;
	...
	uvm_reg_field rsvd;
	rand uvm_reg_field BGE, EPS, PEN, STB, WLS;
	...
	virtual function void build();
		...
		BGE.configure(this, 1, 5, "RW", 1'b0, 1'h0, 1, 1, 1);
		EPS.configure(this, 1, 4, "RW", 1'b0, 1'h0, 1, 1, 1);
		PEN.configure(this, 1, 3, "RW", 1'b0, 1'h0, 1, 1, 1);
		STB.configure(this, 1, 2, "RW", 1'b0, 1'h0, 1, 1, 1);
