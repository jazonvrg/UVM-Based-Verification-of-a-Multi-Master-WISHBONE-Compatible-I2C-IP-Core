class disenable_full_rx_fifo_test extends uart_base_test;
	`uvm_component_utils(disenable_full_rx_fifo_test)
	...
	function new(string name = "disenable_full_rx_fifo_test", uvm_component parent);
	...
	virtual task run_phase(uvm_phase phase);
		...
		$display("============================================================================================================================");
		$display("===========================================  ### FULL RX FIFO | DISENABLE ###  =============================================");
		$display("============================================================================================================================");
