class TX_13x_combination_test extends uart_base_test;
	`uvm_component_utils(TX_13x_combination_test)
	...
	function new(string name = "TX_13x_combination_test", uvm_component parent);
