class RX_13x_combination_test extends uart_base_test;
	`uvm_component_utils(RX_13x_combination_test)
	...
	function new(string name = "RX_13x_combination_test", uvm_component parent);
