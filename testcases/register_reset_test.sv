class register_reset_test extends uart_base_test;
	`uvm_component_utils(register_reset_test)

	uvm_reg_bit_bash_seq reg_bit_bash_seq;
	uvm_reg_hw_reset_seq reg_hw_reset_seq;

  	function new(string name = "register_reset_test", uvm_component parent);
